...
from app.core.config import API_KEY, GEMINI_MODEL
...
# =========================================================
# 7. Main Generation Function (API Entry Point)
# =========================================================
def generate_feedback_results(domain: str, assignment_prompt: str, rubric: dict, submissions: list) -> list:
    all_results = []
    for idx, submission in enumerate(submissions, start=1):
        prompt_str = build_feedback_prompt(domain, assignment_prompt, rubric, submission)
