...
class EvaluateModel:
    ...
    def __init__(self, dataset, model_type, model=None, tokenizer=None, device="automap"):
        """
    ...
    # ----------------------------
    def visualize_rollout(model, tokenizer, text, prompt, title="Attention Rollout"):
        """
        ...
        """
        attn_rollout = AttentionRollout(tokenizer, model, device="cuda")
    ...
    def visualize_attention_weights(model, tokenizer, text, prompt, title="Attention Weights"):
        """
        ...
        attn_weight = AttentionWeight(tokenizer, model, device="cpu")  # or "cuda"
        
        # Suppose you have a model and tokenizer loaded
        text = "The quick brown fox jumps over the lazy dog."
        prompt = "Input text: The quick brown fox jumps over the lazy dog."
